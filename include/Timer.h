...
#ifndef __PBURST_TIMER_H
#define __PBURST_TIMER_H
...
class Timer {
  public:
    ...
    Timer(const timerId addId, const time_t addInterval, const unsigned int addRuncount, const bool addPersistent, TimerHandler *addTimerHandler) {
      myId = addId;
...
class name##Timer : public TimerHandler { \
  public: \
    name##Timer() {} \
    virtual ~name##Timer() {} \
    typedef Timer::timerId timerId; \
